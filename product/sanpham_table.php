...
<?php
    ...
    if (in_array('add', $permissions[$user_group]['sanpham'])) {
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/Admin/product/Product_Controller.php">
                        <div class="mb-3 row">
                            <div class="col-6">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/Admin/product/Product_Controller.php">
                        ...
                        <div class="modal-footer">
                        <?php
                        if (in_array('edit', $permissions[$user_group]['sanpham'])) {
    ...
    <div class="modal fade" id="QuantityModal" tabindex="-1" aria-labelledby="QuantityModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-l">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/Admin/product/Quantity_Controller.php" id="size_form">
